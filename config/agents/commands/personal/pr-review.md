...
> **Instructions**: Execute each task in the order given to conduct a thorough code review.
> **Important**: The future is now—any improvements or "future" recommendations must be addressed **immediately**.
> **Note**: Do NOT automatically submit reviews to GitHub. Present the review results for manual action.
...
**Important**:
- Compile all review findings into a comprehensive summary
- Do NOT use GitHub API tools to submit reviews automatically
- Present the review results in a format suitable for manual submission
- Include all required actions and recommendations clearly
